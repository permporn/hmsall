...
$table_db="ex_set"; // ตารางที่ต้องการค้นหา

$find_field="name_set"; // ฟิลที่ต้องการค้นหา
...
while ($row = mysql_fetch_array( $results )) {
	...
	$id = $row["id_set"]; // ฟิลที่ต้องการส่งค่ากลับ

	$name = ucwords( strtolower( $row["name_set"] ) ); // ฟิลที่ต้องการแสดงค่า
