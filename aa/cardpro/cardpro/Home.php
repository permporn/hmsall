                         ...
                         <div class="pad_left11">
                          ...
                          <? $i=1;
							...
							while($objResult = mysql_fetch_array($objQuery))
								...
								?>
                            <tr>
                            <td width="100%"     class="tblx" style="white-space: nowrap;"><a href="subterm.php?id_year=<?=$objResult["id"];?>&branchid=<?=$objResult99["branchid"];?>"><? if($i==1){ ?><img src="images/Red pin.png"/> <? } else {?><img src="images/Black pin.png"/> <? } ?><?=$objResult["nameyear"];?></a></td>
                           </tr> 
                           <?
								 $i++; }
								?>
