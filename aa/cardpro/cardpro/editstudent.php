		...
		<section id="content">
			...
			<article class="col11">
             ...
             <tr>
               ...
               <td width="155" colspan="5" class="tblyy"><a href="changecourse.php?learnid=<?=$_GET["learnid"]?>&id_year=<?=$_GET["id_year"];?>&branchid=<?=$_GET["branchid"];?>" style="text-decoration:none"><img src="images/48.png" width="48" height="48">เปลี่ยนคอร์ส</a></td>
             </tr>
             <tr>
               ...
               <td colspan="5" class="tblyy"><a href="JavaScript:if(confirm('ยืนยันการยกเลิกคอร์ส?\n\n -ที่นั่ง <?=$objResult["seat"]?> จะว่าง \n -ไม่มีการเลื่อนที่นั่ง')==true){window.location='dellearn.php?learnid=<?=$_GET["learnid"];?>&id_year=<?=$_GET["id_year"];?>&subid=<?=$objResult["subcode"];?>&branchid=<?=$_GET["branchid"];?>';}" style="text-decoration:none"><img src="images/79.png" width="48" height="48"> ยกเลิกคอร์ส</a></td>
             </tr>
             <tr>
              <?
                         $strSQL1 = "SELECT * FROM subject WHERE subcode = '".$objResult["subcode"]."' AND id_year = '".$_GET["id_year"]."'";
               ...
               <td colspan="5"  class="tblyy"><a href="changeseat.php?learnid=<?=$_GET["learnid"]?>&id_year=<?=$_GET["id_year"];?>&branchid=<?=$_GET["branchid"];?>&subid=<?=$objResult1["subid"];?>" style="text-decoration:none"><img src="images/72.png" width="48" height="48"> เปลี่ยนที่นั่ง</a></td>
             </tr>
             <tr>
               ...
               <td colspan="5"  class="tblyy"><a href="printcard2.php?learnid=<?=$_GET["learnid"]?>&id_year=<?=$_GET["id_year"];?>" style="text-decoration:none"><img src="images/Printer_Picture.png" width="40" height="40"> พิมพ์บัตร</a></td>
             </tr>
             <tr>
