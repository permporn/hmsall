		...
		<section id="content">
			...
			<article class="col11">
						<div class="pad_left11">
							<h2><img src="images/expbranch.jpg"/></h2>
						</div>
                         ...
                         <div class="pad_left11">
                            ...
                            <tbody>
                            <tr>
                           <td width="100%"     class="" style="white-space: nowrap;"><div align="center"><img src="images/time_go.png"/><strong> สาขา</strong></div></td>
                          ...
                          <? $i=1;
							...
							while($objResult = mysql_fetch_array($objQuery))
								...
								?>
                            <tr>
                            <td width="100%"     class="tblx" style="white-space: nowrap;"><div align="center"><a href="expsubstu.php?id_year=<?=$_GET["id_year"];?>&&branchid=<?=$objResult["branchid"];?>"><img src="images/user.png"/><?=$objResult["branchname"];?></a></div></td>
                           </tr> 
                           <?
								 $i++; }
								?>
