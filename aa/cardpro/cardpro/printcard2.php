...
$objResult = mysql_fetch_array($objQuery);
                            ...
                            //3 ชื่อนามสกุล
                            $top = $top + 16;
							$strSQL1 = "SELECT * FROM subject JOIN room ON subject.roomid = room.roomid JOIN branch ON room.branchid = branch.branchid WHERE subcode = '".$objResult["subcode"]."' AND id_year = '".$_GET["id_year"]."'";
