			...
			<article class="col11">
						<div class="pad_left11">
                         ...
                         <div class="pad_left11">
                          ...
                          <? $i=1;
						    $strSQL1 = " SELECT DISTINCT  year FROM  learn ";
							$objQuery1 = mysql_query($strSQL1) or die ("Error Query [".$strSQL."]");
							while($objResult1 = mysql_fetch_array($objQuery1))
								{
							$strSQL = "SELECT * FROM yearterm WHERE year = '".$objResult1["year"]."' ";
							$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
							while($objResult = mysql_fetch_array($objQuery))
								{
								?>
                            <tr>
                            <td width="100%"     class="tblx" style="white-space: nowrap;"><div align="center"><a href="subterm.php?idyear=<?=$objResult["id_year"];?>&branchid=<?=$objResult99["branchid"];?>"><? if($i==1){ ?><img src="images/Red pin.png"/> <? } else {?><img src="images/Black pin.png"/> <? } ?><?=$objResult["year"];?></a></div></td>
                           </tr> 
                           <?
								 $i++; }}
								?>
