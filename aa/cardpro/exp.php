                         ...
                         <div class="pad_left11">
                          ...
                          <? $i=1;
							...
							while($objResult = mysql_fetch_array($objQuery))
								...
								?>
                            <tr>
                            <td width="100%"     class="tblx" style="white-space: nowrap;"><div align="center"><a href="expbranch.php?termid=<?=$objResult["termid"];?>"><? if($i==1){ ?><img src="images/Red pin.png"/> <? } else {?><img src="images/Black pin.png"/> <? } ?><?=$objResult["term"];?></a></div></td>
                           </tr> 
                           <?
								 $i++; }
								?>
