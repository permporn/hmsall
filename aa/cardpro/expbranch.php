                         ...
                         <div class="pad_left11">
                          ...
                          <? $i=1;
							...
							while($objResult = mysql_fetch_array($objQuery))
								...
								?>
                            <tr>
                            <td width="100%"     class="tblx" style="white-space: nowrap;"><div align="center"><a href="expsubstu.php?termid=<?=$_GET["termid"];?>&&branchid=<?=$objResult["branchid"];?>"><img src="images/user.png"/>  <?=$objResult["branchname"];?></a></div></td>
                           </tr> 
                           <?
								 $i++; }
								?>
