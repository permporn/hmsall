...
$strSQL = "SELECT * FROM learn JOIN student ON learn.studentid = student.studentid WHERE subcode = '".$_GET["subid"]."'";
	...
	?>
<form name="frmMain" action="<?=$_SERVER["PHP_SELF"];?>?termid=<?=$_GET["termid"];?>&branchid=<?=$_GET["branchid"];?>&subid=<?=$_GET["subid"];?>&action=save" method="post" >
...
<td width="10%" style="white-space:nowrap;" class="tblyy"><div align="center"><?=$i;?></div></td>
    <td width="20%" style="white-space:nowrap;" class="tblyy"><div align="center"><a href="studentdetail.php?studentid=<?=$objResult["studentid"];?>"><?=$objResult["studentname"];?></a></div></td>
        ...
        <td width="10%" style="white-space:nowrap;" class="tblyy"><div align="center">
          ...
          <input name="btnAdd" type="button" id="btnCancel" class="tbl-border" value="Cancel" OnClick="window.location='<?=$_SERVER["PHP_SELF"];?>?termid=<?=$_GET["termid"];?>&branchid=<?=$_GET["branchid"];?>&subid=<?=$_GET["subid"];?>';"></div></td></tr>
<? }
else{
	?>
  <tr>
  <td width="10%" style="white-space:nowrap;" class="tblyy"><div align="center"><?=$i;?></div></td>
    <td width="20%" style="white-space:nowrap;" class="tblyy"><div align="center"><a href="studentdetail.php?studentid=<?=$objResult["studentid"];?>"><?=$objResult["studentname"];?></a></div></td>
        ...
        <td width="20%" style="white-space:nowrap;" class="tblyy"><div align="center"><?=$objResult['finaltest']+$objResult['sumpoint'];?></div></td>
        <td width="10%" style="white-space:nowrap;" class="tblyy"><div align="center"><a href="<?=$_SERVER["PHP_SELF"];?>?Action=Edit&CusID=<?=$objResult["learnid"];?>&learnid=<?=$objResult["learnid"];?>&termid=<?=$_GET["termid"];?>&branchid=<?=$_GET["branchid"];?>&subid=<?=$_GET["subid"];?>"><img src="images/edit (1).png"/></a></div></td>
  </tr>
<?
}
}
...
?>
  ...
  <p><a href="printpoint.php?subid=<?=$_GET["subid"];?>&termid=<?=$_GET["termid"];?>&branchid=<?=$_GET["branchid"];?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','images/printpoint1.jpg',1)"><img src="images/printpoint.jpg" name="Image5" width="224" height="51" border="0"></a></p>
</form>
						</div>
               		</article>
                        <div class="pad_left11">
