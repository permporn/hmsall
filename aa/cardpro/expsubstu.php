...
make_autocom("show_arti_topic","h_arti_id");
	...
	{
$strSQL = "SELECT * FROM subject JOIN room ON subject.roomid = room.roomid WHERE termid = '".$_GET["termid"]."' && branchid = '".$_GET["branchid"]."'";
...
<table class="tbl-border" cellpadding="0" cellspacing="1" width="100%">
	...
	?>
	  <tr>
		<td width="100%" style="white-space:nowrap;" class="tblyy"><div align="center"><a href="expstudent.php?subid=<?=$objResult["subcode"];?>&termid=<?=$_GET["termid"];?>&branchid=<?=$_GET["branchid"];?>"><img src="images/Yellow tag.png"/><?=$objResult["subname"];?> <?=$objResult["subcode"];?></a> (<?=$objResult8["sum"];?> คน)</div></td>
	...
	{
$strSQL = "SELECT * FROM subject JOIN room ON subject.roomid = room.roomid WHERE subname = '".$_GET["h_arti_id"]."'";
$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
$Num_Rows = mysql_num_rows($objQuery);
$Per_Page = 25;   // Per Page
...
<table class="tbl-border" cellpadding="0" cellspacing="1" width="100%">
	...
	?>
	  <tr>
		<td width="100%" style="white-space:nowrap;" class="tblyy"><div align="center"><a href="student.php?subid=<?=$objResult["subcode"];?>&termid=<?=$_GET["termid"];?>&branchid=<?=$_GET["branchid"];?>"><img src="images/Yellow tag.png"/><?=$objResult["subname"];?> <?=$objResult["subcode"];?></a>(<?=$objResult8["sum"];?> คน)</div></td>
