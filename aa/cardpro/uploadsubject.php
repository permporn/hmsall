		...
		<section id="content">
			...
			<article class="col11">
						<div class="pad_left11">
                         ...
                         <div class="pad_left11">
							 <form action="UploadSave1.php" name="frmMain" method="post" enctype="multipart/form-data" target="iframe_target" onSubmit="return ChkSubmit();">
...
document.getElementById("divresult").innerHTML = "<font color=red> Error!! Cannot upload data </font> <br>";
 ...
 <center>ไฟล์ธนาคาร : <input name="file" type="file" id="file" />
 <input type="hidden" name="MAX_FILE_SIZE" value="200000000" /> 
<input name="send" type="submit" class="select" value="ดึงค่า" />(.xls)
</form>
<div id="divresult"></div>
<div id="progress" style="visibility:hidden"><img src="progress.gif"></div></center>
</center>
						</div>
               		</article>
                        <div class="pad_left11">
