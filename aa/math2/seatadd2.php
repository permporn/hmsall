...
echo "<meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />";
?>
<script language='javascript'>alert('เสียเครดิต <?=$_GET['section2'] - $_GET['section1']?> เครดิตในการจองเวลาเรียนนะค่ะ จองเวลาเรียบร้อยแล้วค่ะ');</script>;
<?
echo "<meta http-equiv='refresh' content='0;URL=home.php?date=$dateold&local=$localold'>";
}
