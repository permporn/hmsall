...
$strSQL = "SELECT ptt_r.name ,ptt_r.id , ptt_r.money_pay ,ptt_r.money_repay ,ptt_r.money_fee ,ptt_r.money_balance ,ptt_r.type_pay,acc.name staff
...
?>
      ...
      <table class="tbl-border" cellpadding="0" cellspacing="1" width="100%" align="left" style="margin-top:20px; padding:10px">
       ...
       <tr>
            ...
            <td width="" colspan="1" align="left" class="tblyy13">รหัสบัตร: <?=$objResult["name"]?></td>
       </tr>
       <tr>
               ...
               <table  width="100%" align="center" class="tbl-border2" >
                    ...
                    <tr>
                    	<td width="62%" colspan="" align="left" class="tblyy14"  height="20">- ค่า ต่ออายุ HMS Card</td>
