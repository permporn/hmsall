...
$('.btn_insert_cancel_bill').click(function(){
  ...
  $.ajax({
      ...
      data: {id : id , type : "update_cancel_bill" ,id_account_self : id_account_self, status : status , remark : remark},
  ...
  <div class="imageupload panel panel-default">
      ...
      <div class="panel-heading clearfix">
          ...
          <h3 class="panel-title pull-life col-md-7">
            ...
            <span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> ยกเลิกใบเสร็จ </h3>
      ...
      <div class="bill_full" id="bill_full"></div>
        ...
        <div class="form-group col-sm-12">
            ...
            <label for="" class="col-sm-12 control-label"><h4><span class="glyphicon glyphicon-hand-right" aria-hidden="true"></span> ยกเลิกใบเสร็จ - สำหรับเจ้าหน้าที่ :</h4></label>

        </div>

        <div class="form-group col-sm-12">

            <label for="remark" class="col-sm-3 control-label">หมายเหตุการยกเลิกใบเสร็จ</label>
...
<center>
    ...
    <button type="button" class="btn btn-primary btn_insert_cancel_bill" id="btn_insert_cancel_bill">บันทึก</button></h4>
