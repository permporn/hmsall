  ...
  <div class="imageupload panel panel-default">
      ...
      <div class="panel-heading clearfix">
          ...
          <h3 class="panel-title pull-life col-md-7">
            ...
            <span class="glyphicon glyphicon-new-window" aria-hidden="true"></span> การจัดส่งใบเสร็จ </h3>
      ...
      <div class="bill_full" id="bill_full"></div>
        ...
        <div class="form-group col-sm-12">
            ...
            <label for="remark" class="col-sm-3 control-label">เจ้าหน้าที่แจ้งจัดส่งหมายเหตุ</label>
