 $(function() {
        ...
        $('.btn-gen').click(function(){
            ...
            var staff_id = $('#staff_id_bill').val();
            ...
            if(teacher != null && branch != null && pay != null){
                ...
                $.ajax({
                    type: "GET",
                    url: url,
                    data: { action_type : "insert_bill", quantity : quantity , s_date : s_date , e_date : e_date , type : type , subject : subject , branch : branch , term : term , teacher : teacher , pay : pay , set_pay : set_pay , price_self : price_self,  staff_id : staff_id},
                    success: function(data){
                        console.log(data);
                        $.ajax({
                            type: "POST",
    ...
    $('.btn-pay-setting').click(function(){
     ...
     // page course setting
    $('.btn-course-setting').click(function(){
        $.ajax({
            type: "POST",
            ...
            success: function(data){
                ...
                $("#data-table").html(data);
                $(".header").hide();
                $('#header_title').html('<span class="glyphicon glyphicon-search" aria-hidden="true" ></span> ตั้งค่าประเภทคอร์ส'); 
            } 
        });
    });
});
