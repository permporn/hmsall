...
<div class="form-group col-sm-12 book_self_">
  ...
  <select id="teacher_self1" class="form-control teacher_self1" name="teacher_self1">
      ...
      <?php 
          ...
          ?>
          <option value="<?=$objResult_teacher['teacherid']?>" <? if($objResult_book['teacherid'] == $objResult_teacher['teacherid']){ ?>selected="selected" <? }?> ><?=$objResult_teacher['teachername']?></option>
       <? }?>
  </select>
  </div>
</div>
    ...
    <label for="type_book" class="col-sm-2 control-label">ประเภท</label>
      <div class="col-sm-5">  
        <select class="form-control type_book" id="type_book" name="type_book" >
          ...
          $objQuery_type = mysql_query($strSQL_type) or die ("Error Query [".$strSQL_type."]");
          while ( $objResult_type = mysql_fetch_array($objQuery_type)) {?>
            <option value="<?=$objResult_type['type_id']?>">คอร์ส<?=$objResult_type['type_name']?></option>
          <? } ?>
        </select>
       </div>
</div>
