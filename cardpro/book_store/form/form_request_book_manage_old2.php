...
$objResult_requests = mysql_fetch_array($objQuery_requests);
  ...
  <div class="form-group col-sm-12">
      <label for="approve_remark" class="col-sm-2 control-label">ไม่อนุมัติ หมายเหตุ</label>
        <div class="col-sm-2">  
          <input type='text' id="approve_remark" name='approve_remark' class='form-control approve_remark' readonly="readonly"  value="<?=$objResult_requests['approve_remark'];?>" />
        </div>
  </div>
  <? }?>
  <div class="form-group col-sm-12">
