...
$.ajax({
    ...
    data: { data_all : "all" , id_branch : id_branch},
 ...
 <div class="row">
    <input type="hidden" id="id_branch" name="id_branch" value="<?=$id_branch_self;?>">
       <!-- <div class="col-lg-12">
            <input type="hidden" id="id_branch" name="id_branch" value="<?=$id_account_self;?>">
        ...
        <h4>
        <span class="glyphicon glyphicon-list" aria-hidden="true"></span> STORE หนังสือ
        <!-- <button type="button" class="btn btn-info btn-sm add_request_book"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> เพิ่ม</button> -->
        </h4>
        </div>
