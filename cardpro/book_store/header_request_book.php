...
<div class="row">
        ...
        <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"> รายการสั่งซื้อหนังสือ 
        <? //if($account_status == 'admin'){?>
        <button type="button" class="btn btn-info btn-sm add_request_book padding-right: 200px;"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>สั่งซื้อ</button>
        <? //}else{ }?>
        </h4>
        </div><img src="images/tag_status2.png" width="450px" align="right" />
