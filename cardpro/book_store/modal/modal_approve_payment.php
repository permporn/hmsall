      ...
      <table id="" class="display" cellspacing="0" width="100%">
        ...
        <div class="form-group col-sm-12">
            <label for="remark" class="col-sm-3 control-label">หมายเหตุ</label>
              <div class="col-sm-9" id="modal_approve_approve_remark" name="modal_approve_approve_remark">  
        ...
        <div class="form-group col-sm-12">
            <label for="remark" class="col-sm-3 control-label">ที่อยู่จัดส่ง</label>
              <div class="col-sm-9" id="modal_approve_delivery_address" name="modal_approve_delivery_address">  
                <!-- <textarea id="modal_approve_approve_remark" name="" rows="3" cols="35" class="form-control" placeholder="หมายเหตุ" readonly="readonly"></textarea> -->
              </div>
        </div>
        ...
        <div class="form-group col-sm-12">
              <label for="" class="col-sm-3 control-label">การตรวจสอบ</label>
              <div class="col-sm-9">  
                <select name="modal_approve_payment_status" id="modal_approve_payment_status">
                  <option value="4">ยืนยันการชำระถูกต้อง</option>
                  <option value="2">การชำระไม่ถูกต้อง</option>
                </select>
        ...
        <div class="form-group col-sm-12">
              <label for="remark" class="col-sm-3 control-label">หมายเหตุ</label>
                <div class="input-group col-sm-9">  
                  <textarea id="modal_approve_payment_remark_admin" name="modal_approve_payment_remark_admin" rows="6" cols="35" class="form-control" placeholder="หมายเหตุ"></textarea>
                </div>
        </div>
