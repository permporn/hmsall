<form method="get" id="form_approve_payment">
  ...
  <div class="modal-body">
      <table id="" class="display" cellspacing="0" width="100%">
        ...
        <div class="form-group col-sm-12">
        <label for="modal_approve_payment_sum_price_book" class="col-sm-3 control-label">ค่าหนังสือ(บาท)</label>
            <div class="col-sm-5">  
            <div name="modal_approve_payment_sum_price_book" id="modal_approve_payment_sum_price_book"></div>
           </div>
        </div>

        <div class="form-group col-sm-12">
        <label for="modal_approve_payment_shipping_charge" class="col-sm-3 control-label">ค่าจัดส่ง(บาท)</label>
            <div class="col-sm-5">  
            <div name="modal_approve_payment_shipping_charge" id="modal_approve_payment_shipping_charge"></div>
            </div>
        </div>
        ...
        <div class="form-group col-sm-12">
            <label for="remark" class="col-sm-3 control-label">หมายเหตุ</label>
              <div class="col-sm-9">  
                <div id="modal_approve_payment_remark" name="modal_approve_payment_remark"></div>
              </div>
        </div>

         <div class="form-group col-sm-12">
            <label for="modal_approve_delivery_address" class="col-sm-3 control-label">ที่อยู่จัดส่ง</label>
              <div class="col-sm-9">  
                <div id="modal_approve_delivery_address" name="modal_approve_delivery_address"></div>
              </div>
        </div>
