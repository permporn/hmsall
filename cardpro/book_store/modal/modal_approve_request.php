  ...
  <div class="modal-body">
      <table id="" class="display" cellspacing="0" width="100%">
        ...
        <label for="code" class="col-sm-3 control-label">เลขใบสั่งซื้อ</label>
            <div class="col-sm-4" name="modal_approve_book_code" id="modal_approve_book_code" >  
            <input type="hidden" class="form-control" name="modal_approve_book_code" id="modal_approve_book_code" readonly="readonly" />
           </div>
        </div>  
        <div class="form-group col-sm-12">
        <label for="title" class="col-sm-3 control-label">จำนวนหนังสือ(เล่ม)</label>
            <div class="col-sm-4" name="modal_approve_qty" id="modal_approve_qty">  
            <input type="hidden" class="form-control" name="modal_approve_qty" id="modal_approve_qty" readonly="readonly" />
           </div>
        </div>

        <div class="form-group col-sm-12">
        <label for="type" class="col-sm-3 control-label">ยอดเงินทั้งหมด(บาท)</label>
            <div class="col-sm-4" name="modal_approve_sum_price" id="modal_approve_sum_price">  
            <input type="hidden" class="form-control" name="modal_approve_sum_price" id="modal_approve_sum_price" readonly="readonly" />
           </div>
        </div>
        ...
        <label for="qty" class="col-sm-3 control-label">หมายเหตุ</label>
            <div class="col-sm-9"  id="modal_approve_remark2" name="modal_approve_remark2">  
        ...
        <label for="qty" class="col-sm-3 control-label">ผู้ทำรายการ</label>
            <div class="col-sm-5" name="modal_approve_staff" id="modal_approve_staff">  
        ...
        <div class="form-group col-sm-12">
            <label for="qty" class="col-sm-3 control-label">ค่าจัดส่ง</label>
              <div class="col-sm-9">  
                    ...
                    <input type='button' value='+' class='qtyplus_shipping_charge' field='shipping_charge' /> บาท  
                    <font color="red">**กรอกเป็นตัวเลข ไม่มีทศนิยม</font>
              </div>
