...
<div id="container">
  ...
  <div id="content">
   <!-- <h1>ใบคำร้อง</h1>-->
	...
	?>
    <form name="form1" method="post" action="endorsee_request_insert.php?ac=edit&id=<?=$result_ReqEdit["id"]?>">
      	...
      	<input type="hidden" name="branchid" id="branchid" value="<?=$objResultSTT["branchid"]?>" />
        	...
        	<tr >
             ...
             <tr>
              ...
              <td align="left" class="tblyy" ><input type="date" name="today" id="today" value="<?=date('Y-m-d')?>" readonly="readonly" /></td>
            </tr>
            <tr>
           	  <td align="left" height="30" class="tblyy2"><strong>วันที่ร้องขอ</strong></td>
              <td align="left" class="tblyy" ><input type="date" name="date_request" id="date_request" value="<?=$result_ReqEdit["date_request"]?>" /></td>
            </tr>
            <tr>
           	  <td align="left" height="30" class="tblyy2"><strong>เรื่อง</strong></td>
           	  <td align="left" class="tblyy" ><input type="text" name="subject" id="subject" value="<?=$result_ReqEdit["subject"]?>" /></td>
            </tr>
            <tr>
           	  <td align="left" height="30" class="tblyy2"><strong>เรียน</strong></td>
           	  <td align="left" class="tblyy" ><input type="text" name="request_to" id="request_to" value="<?=$result_ReqEdit["request_to"]?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="left" height="30" class="tblyy2"></td>
           	  <td align="left" class="tblyy" >
      			...
      			<input type="button" name="cmdweblogin" class="button" value="ยกเลิก" onClick="window.location='endorsee_home.php'"/> 
    ...
    if($_POST['type'] == 0){
		...
		echo "<meta http-equiv='refresh' content='0;URL=endorsee_home.php'>";
		exit();
	}
	else if($_POST['type'] == '1' || $_POST['type'] == '3'){
	?>
    <form name="form1" method="post" action="endorsee_request_insert.php?ac=add">
    <input type="hidden" id="type" name="type" value="<?=$_POST["type"]?>" />
        <input type="hidden" name="accid_user" id="accid_user" value="<?=$objResultSTT["accid"]?>" />
      	...
      	<table class="tbl-border" cellpadding="0" cellspacing="1" width="90%" align="center">
            ...
            <tr>
           	  <td align="left" height="30" class="tblyy2"><strong>วันที่บันทึก</strong></td>
              <td align="left" class="tblyy"><input type="date" name="today" id="today" value="<?=date('Y-m-d')?>" readonly="readonly" style="border:none"/></td>
            </tr>
            <tr>
              <td align="left" height="30" class="tblyy2"><strong>วันที่ร้องขอ</strong></td>
            ...
            <tr>
              <td align="left" height="30" class="tblyy2"><strong>เรื่อง</strong></td>
           	  <td align="left" class="tblyy"><input type="text" name="subject" id="subject" value="" style="width:300px"/>
              <font color="#EE0000"><strong> *</strong></font></td>
            </tr>
            <tr>
              <td align="left" height="30" class="tblyy2"><strong>เรียน</strong></td>
            ...
            <tr>
              ...
              ชื่อคอร์ส :<input name="course_name" id="course_name" />
              รหัสคอร์ส :<input name="course_code" id="course_code" style="width:100px"/>
              ราคา :<input name="course_price" id="course_price" style="width:100px" />
              วันที่โอน :<input type="date" name="course_transfer" id="course_transfer" value="<?=date('Y-m-d')?>"  />
              <br /><font color="#EE0000"><strong> *</strong> กรุณากรอกข้อมูลให้ครบถ้วนเพื่อให้การดำเนินการรวดเร็วยิ่งขึ้น</font></td>
            </tr>
            <tr>
              <td align="left" height="30" class="tblyy2"><strong>เนื่องจาก</strong></td>
        ...
        <input type="hidden" name="accid_user" id="accid_user" value="<?=$objResultSTT["accid"]?>" />
      	...
      	<table class="tbl-border" cellpadding="0" cellspacing="1" width="90%" align="center">
            ...
            <tr>
              ...
              <strong>- เปลี่ยนเป็น</strong><br />
              ชื่อคอร์ส : <input name="course2_name" id="course2_name" />
              รหัสคอร์ส : <input name="course2_code" id="course2_code" style="width:100px"/>
              ราคา : <input name="course2_price" id="course2_price" style="width:100px" />
              <br /><br /><font color="#EE0000"><strong> *</strong> กรุณากรอกข้อมูลให้ครบถ้วนเพื่อให้การดำเนินการรวดเร็วยิ่งขึ้น</font>
            </td></tr>
            <tr>
              <td align="left" height="30" class="tblyy2"><strong>เนื่องจาก</strong></td>
    ...
    <? }} ?>
    <div align="right">
      <input type="button" name="cmdweblogin" class="button" value="กลับ" onClick="window.location='endorsee_home.php'" style="margin:15px; width:100px ; margin-right:55px"/>
      </div>
