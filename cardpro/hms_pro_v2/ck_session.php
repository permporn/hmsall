<?php
	...
	$objQuerySTT = mysql_query( $strSTT,$connect_school) or die ("Error Query [".$strSTT."]");
	...
	if($_SESSION["accid_cardpro"] == ""){
	    ...
	    $objQuery_school = mysql_query($strSQL_school ,$connect_self) or die ("Error Query [".$strSQL_school."]");
