...
<div id="menu">
    <ul class="menu">
        <li><a href="index.php"><span>หน้าแรก</span></a>
                ...
                <div><ul>
                    ...
                    <li><a href="#" class="parent"><span>จัดการข้อมูล</span></a>
                        <div><ul>
                            ...
                            <? if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["accid"]=="51" || $objResultSTT["accid"]=="14") {?>
                            <li><a href="manageall.php"><span>จัดการข้อมูลอื่นๆ</span></a></li>
                            <? }?>
                        </ul></div>
                    </li>
                    <? if($objResultSTT["accid"]=="28" || $objResultSTT["accid"]=="133" || $objResultSTT["accid"]=="117" || $objResultSTT["accid"]=="134") {?>
            ...
            <? }?>
            <li><? if($objResultSTT["status"]=="Manager" or $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["accid"]=="59" || $objResultSTT["accid"]=="10" || $objResultSTT["accid"]=="14" || $objResultSTT["accid"]=="26" || $objResultSTT["accid"]=="29" || $objResultSTT["status"] == "admin_hms") {?>
            ...
            <li><a href="self/searchstudent.php" class="parent"><span>SELF</span></a>
                <div><ul>
                  ...
                  <? if($objResultSTT["status"] != "manager_franchise" && $objResultSTT["status"] !="user_franchise" && $objResultSTT["status"] != "pre_end"){?>
                    ...
                    <? }}?>
                    <? if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["accid"]=="23") {?>
...
<? if($objResultSTT["accid"]=="28" || $objResultSTT["accid"]=="133" || $objResultSTT["accid"]=="76" || $objResultSTT["accid"]=="94" || $objResultSTT["accid"]=="99" || $objResultSTT["accid"]=="117" || $objResultSTT["accid"]=="134" || $objResultSTT["status"] =="teacher" || $objResultSTT["accid"]=="55") {?>
<li><a href="report/index.php" target="_blank"><span> สรุปยอด </span></a></li><? } ?>
<? if( ($objResultSTT["status"]=="manager_franchise" || $objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["status"]=="manager_franchise" || $objResultSTT["status"] == "admin_hms" || $objResultSTT["status"]=="user_franchise" || $objResultSTT["status"]=="pre_end") && $objResultSTT["status"] !="teacher"){?>
