...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <section id="intro" class="intro-section">
        ...
        <div class="container">
            ...
            <!-- /.row -->
			<!-- <center><img class="loaderImage" src="images/ajax-loader.gif" /></center> -->
            <div class="loaderImage"><center><img src="images/ajax-loader.gif" /></center></div>
			<!-- button seat -->
            <div class="row">
				...
				<!-- Modal-form-Datatable-Print--> 
				<?php include('modal/modal_table_student_print.php');?>	
