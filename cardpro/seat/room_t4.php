            ...
            <div class="row">
                ...
                <div class="col-md-12 thumbnail" align="center">
					...
					<table width="40%" align="center">
					        <tr bgcolor="#E6E6E6">
					            <td colspan="19" height="60px"><center><img src="images/screen.png" title="เวที และกระดาน" class="tootip" width="420px"></center></td>
	 				        </tr>
	 				        <tr bgcolor="#E6E6E6">
					            <td colspan="13" bgcolor="" height="75px" ></td>
					            <td rowspan="5">ทางเดิน</td>
	 				        </tr>	 				        
					        ...
					        <tr bgcolor="#E6E6E6">
					        	<td height="55px"><button id="seat0" name="test" class="seat btn btn-default" data-value="" disabled="disabled">D</button></td>
					            <!-- 16 -->
