...
<div id="container">
  ...
  <div id="content">
    ...
    <br /> <br /> <br />
    <form name="frmMain" action="addstudent1.php" method="post" enctype="multipart/form-data"  onSubmit="return chk_null();">
            <table class="tbl-border" cellpadding="0" cellspacing="1" width="50%" align="center">
            <tr>
            <td colspan="3" class="tblyy">
            <center><font color="#FF0000"><strong>*กรุณากรอกข้อมูลให้ครบถ้วนและถูกต้องเพื่อเป็นประโยชน์แก่องค์กร</strong></font></center>
            </td>
            </tr>
             <tr>
               ...
               <input type="text" name="txtUsername" id="txtUsername" OnChange="JavaScript:doCallAjax();"><span id="mySpan"></span>
               <font color="#FF0000"><strong> *</strong> การพิมพ์รายชื่อต้องพิมพ์ชื่อเว้นวรรณ 1 ที ตามด้วยนามสกุล เช่น เด็กโต้ง ขยันเรียน </font></td>
             </tr>
             <tr>
