...
<div id="container">
  <? include('menu.php');?>
  <div id="content">
    <h1>จัดการ account self โปรโมชั่น self after school *เฉพาะพญาไท</h1>
    <p>
    <div align="right">
           ...
           <table class="tbl-border" cellpadding="0" cellspacing="1" width="80%" align="center">
             ...
             <tr>
               ...
               <td width="60%" class="tblyy" height="35">
                 ...
                 <a href="addstudent.php?type=addacount">เพิ่มรายชื่อ</a></td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td width="60%" class="tblyy" height="35">
               <input type="date" name="date" id="date" value=""></td>
             </tr>
             <!--<tr>
