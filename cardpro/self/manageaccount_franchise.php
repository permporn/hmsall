...
$strSQL = "UPDATE counter SET ";
    ...
    if(!$objQuery)
    {
        ...
        <form name="studentForm" method="post" action="manageacc_franchise.php" onSubmit="return checkForm();">
        <?
        ...
        <table class="tbl-border" cellpadding="0" cellspacing="1" width="80%" align="center">
            ...
            <tr>
                ...
                <td width="60%" class="tblyy" height="35">
                    ...
                    <a href="addstudent.php?type=addacount_franchise">เพิ่มรายชื่อ</a>
                    <br />
                    <font color="#FF0000">
            ...
            <tr>
                ...
                <td width="60%" class="tblyy" height="35">
                <input id="type_pay1" name="type_pay" type="radio" value="transfer" class="input4" checked="checked" />โอน&nbsp;
                <input id="type_pay2" name="type_pay" type="radio" value="cradit" class="input4" /> บัตรเคดิต
                <input id="type_pay3" name="type_pay" type="radio" value="money" class="input4" /> เงินสด 
