                  ...
                  <?php } ?>
                    ...
                    <li><a href="#" class="parent"><span>จัดการข้อมูล</span></a>
                        <div><ul>
                            ...
                            <?php if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["mapid"]=="29" || $objResultSTT["mapid"]=="51") {?>
                             <li><a href="../coursemanage_real_subject.php"><span>จัดการวิชาเรียนจริง</span></a></li>
                             <?php }?>
                        </ul></div>
                    </li>
      <?php if($objResultSTT["mapid"]=="28" || $objResultSTT["mapid"]=="133"  || $objResultSTT["mapid"]=="117" || $objResultSTT["accid"]=="134") {?>
          ...
          <?php }?>
            <li><?php if($objResultSTT["status"]=="Manager" or $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" or $objResultSTT["mapid"]=="59" or $objResultSTT["mapid"]=="10" or $objResultSTT["mapid"]=="14" or $objResultSTT["mapid"]=="23" or $objResultSTT["mapid"]=="29" || $objResultSTT["status"] == "admin_hms") {?>
          ...
          <?php if($objResultSTT["mapid"]=="28" || $objResultSTT["mapid"]=="133"  || $objResultSTT["mapid"]=="117" || $objResultSTT["accid"]=="134") {?>
                  ...
                  <?php }?>
                   ...
                   if( $objResultSTT["status"] == "user" || $objResultSTT["status"]=="Manager"||$objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin"){?>
                     ...
                     <?php }?>
                     <?php if( $objResultSTT["status"] == "manager_franchise" || $objResultSTT["status"]=="admin_hms"||$objResultSTT["status"]=="user_franchise"){?>
                     <li><a href="manageaccount_day_franchise.php" class=""><span>self after school </span></a></li>
                     <?php }}?>
                      <?php if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["mapid"]=="23") {?>
...
<?php if($objResultSTT["mapid"]=="28" || $objResultSTT["mapid"]=="133" || $objResultSTT["mapid"]=="76" || $objResultSTT["mapid"]=="94" || $objResultSTT["mapid"]=="99"  || $objResultSTT["mapid"]=="117" || $objResultSTT["accid"]=="134" || $objResultSTT["status"] == "teacher" || $objResultSTT["accid"]=="55") {?>
<li><a href="../report/index.php"  target="_blank"><span> สรุปยอด </span></a></li><?php } ?>
<?php if(($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["status"]=="manager_franchise" || $objResultSTT["status"] == "admin_hms" || $objResultSTT["status"]=="user_franchise" || $objResultSTT["status"]=="pre_end") && $objResultSTT["status"] != "teacher"){?>
