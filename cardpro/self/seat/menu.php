...
<div id="menu">
    <ul class="menu">
      ...
      <? if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" or $objResultSTT["mapid"]=="14" or $objResultSTT["mapid"]=="59") {?>
                  ...
                  <? if($objResultSTT["status"] != "manager_franchise" && $objResultSTT["status"] !="user_franchise"){?>
                        <div><ul>
                            <li><a href="../coursemanage.php"><span>จัดการวิชาเรียน</span></a></li>
                             <? if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["mapid"]=="29" || $objResultSTT["mapid"]=="51" && ($objResultSTT["status"] != "manager_franchise" && $objResultSTT["status"] !="user_franchise")) {?>
                             <li><a href="../coursemanage_real_subject.php"><span>จัดการวิชาเรียนจริง</span></a></li>
                             <? }?>
                        </ul>
                        </div>
                   ...
                   <li><a href="#" class="parent"><span>คะแนนสอบ</span></a>
                    ...
                    <li><a href="#" class="parent"><span>ที่นั่งself</span></a>
                        <div><ul>
                            ...
                            <? if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["status"]=="manager_franchise" || $objResultSTT["status"]=="user_franchise"){?>
                            <li><a href="" class="parent"><span>จัดการจำนวนที่นั่ง</span></a>
                              <div><ul>
                                 <li><a href="seat_add.php"><span>เพิ่มที่นั่ง</span></a></li>
                                 <li><a href="seat_edit.php"><span>แก้ไข บวก-ลบ ที่นั่ง </span></a></li>
                                 <li><a href="seat_delsecion.php"><span>ลบช่วงเวลา</span></a></li>
                                </ul></div>
                            </li>
                            <? }?>
                        </ul></div>
                    </li>
          <? if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["mapid"]=="14" || $objResultSTT["mapid"]=="59") {?>
                    <li><a href="#" class="parent"><span>สรุปยอด</span></a>
                        <div><ul>
            ...
            <? }?>
             <? if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin"  || $objResultSTT["status"]=="manager_franchise"  || $objResultSTT["status"] == "admin_hms" || $objResultSTT["status"]=="user_franchise") {?>
             <li><a href="../../Manag_account_personnel.php">จัดการ account</span></a></li>
            <? } ?>
            <? if( $objResultSTT["status"] == "user" || $objResultSTT["status"]=="Manager"||$objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin"){?>
<li><a href="../../seat/index.php"  target="_blank"><span>ระบบจองที่นั่ง</span></a></li>
<? }?>
<? if($objResultSTT["status"]=="Manager" || $objResultSTT["status"]=="ADMIN" || $objResultSTT["status"]=="admin" || $objResultSTT["status"]=="manager_franchise") {?>
<li><a href="../../report/index.php"  target="_blank"><span><img src="../../images/icn_new.gif"/> สรุปยอด </span></a></li><? } ?>
<li><a href="../../book_store/index.php"  target="_blank"><span><img src="../../images/icn_new.gif"/> BOOK STORE </span></a></li>
</ul>
