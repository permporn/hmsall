...
<? include('menu.php');?>
<div id="content">
<h1>เพิ่มที่นั่ง SELF</h1>
<p> <strong>+ admin เพิ่มที่นั่ง SELF</strong></p>    
<form id="form1" name="form1" method="post" action="seat_saveadd.php">
...
<tr>
    <td width="20%" class="tblyy2" height="35">จำนวนเครื่อง : </td>
    <td width="60%" class="tblyy" height="35">
