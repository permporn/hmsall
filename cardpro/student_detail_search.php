...
<div id="container">
  ...
  <br /> <br />
  <div align="center">
  <form name="form2" action="student_detail_search.php" method="get">
...
$studentid = $_GET["h_arti_id"];
	...
	$strSQL .=" order by l.regisdate ASC";
...
?>      
      ...
      <? if($num == 0){?>
      <tr>
      	<td class="tblyy" style="white-space: nowrap;" align="center" colspan="9"><font color="#FF0033"><strong>ไม่พบข้อมูล</strong></font></td>
      </tr>
      <? }?>
  </table>
