      ...
      <section id="content">
        <div id="sss"></div>
         ...
         <form action="saveacc.php?accid=<?=$_GET["accid"];?>" method="post" name="frm1">
          <p><strong>+ admin แก้ไขวิชา</strong></p>
          <table width="600" border="1">
             ...
             <tr>
              ...
              <?
				...
				?>
                <tr>
                 <td height="35">หมายเลขใบคำร้อง:</td>
                 <td colspan="3"><input type="text" name="noptt" id="noptt"  size="10" value="<?=$objResult2["no_petition"]?>"> </td>
             	</tr>
