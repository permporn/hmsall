      ...
      <aside>
         ...
         <form action="" id="newsletter-form">
            ...
            <div class="rowElem">
               ...
               <div class="clear">
               <a class="fright" href=javascript:if(confirm('ยืนยันการออกจากระบบ')==true){window.location='logout.php';}>ออกจากระบบ</a>
               </div>
            </div>
            </fieldset>
         </form>
         ...
         <form name="frmMain" action="addstudent22.php" method="post" enctype="multipart/form-data"  onSubmit="return chk_null();">
           ...
           <table width="450" border="1">
             ...
             <tr>
               ...
               <td width="20">&nbsp;</td>
               <td width="52"><a href="javascript:document.frmMain.reset()" onclick="window.history.back()"><center><img src="images/129.png" width="40" height="40"><div id="hh">CANCEL</div></center></a></td>
