        ...
        <SCRIPT LANGUAGE="JavaScript">
            ...
            function pick(symbol) {
                if (window.opener && !window.opener.closed)
                    window.opener.document.addstudentForm.sub.value = symbol;
                window.close();
            }
            // -->
        </SCRIPT>
...
a:active {
    ...
    <BODY text="#D6D6D6" link="#0099FF" vlink="#0099FF" alink="#0099FF">
...
if($_GET["h_arti_id"] == "")
	...
	?>
	  <tr>
		...
		<td height="30"  class="tblyy"><div align="center"><?=$objResult["hour"];?></div></td>
	  </tr>
	<?
	}
	?>
