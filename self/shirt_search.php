   ...
   <div class="container">
    ...
    <table cellpadding="0" cellspacing="1" width="100%">
	  <tr>
		...
		<th width="102" class="tbl2" style="white-space: nowrap;"> รับเสื้อแล้ว/ตัว</th>
        <th width="75" class="tbl2" style="white-space: nowrap;"> รับเสื้อ</th>
	  </tr>
	<?
	...
	?>
	   <tr>
        ...
        <td width="102" class="tblyy"><div align="center"><?=$objResult["shirt"];?></div></td>
        <td width="75" class="tblyy"><div align="center"><a href="shirt_search.php?studentid=<?=$objResult["studentid"];?>&type=Edit&accid=<?=$objResult["accid"]?>&studenname=<?=$stdname;?>"><img src="images/Create.png"width="15" height="15"></div></td>
       </tr>
	<? }?>
	</table>
    <? } ?>
	...
	<? if($_GET["type"] ==  "Edit" && $_GET["studentid"] !=  "" && $_GET["accid"] != '' && $_GET["studenname"] != ''){
        ...
        <br>
          <table cellpadding="0" cellspacing="1" width="100%">
              ...
              <tr>
                <th width="74" class="tbl2" style="white-space: nowrap;">Acc.</th>
                <th width="121" class="tbl2" style="white-space: nowrap;">Username</th>
                <th width="292" class="tbl2" style="white-space: nowrap;"> ชื่อ-นามสกุล</th>
                <th width="257" class="tbl2" style="white-space: nowrap;"> คอร์ส</th>
                <th width="101" class="tbl2" style="white-space: nowrap;"> รับเสื้อแล้ว/ตัว</th>
                <th width="74" class="tbl2" style="white-space: nowrap;"> บันทึก</th>
              </tr>
              <?
        while($objResult = mysql_fetch_array($objQuery2))
        {
        ...
        ?>
              ...
              <tr>
                <td width="74" class="tblyy"><center>
                  <?=$l++;?>
                </center></td>
                <td width="121" class="tblyy"><center>
                  <?=$objResult["username"];?>
                </center></td>
                <td width="292" class="tblyy"><center>
                  <?=$stdname;?>
                </center></td>
                <td width="257" style="white-space:nowrap;" class="tblyy"><?php $n = 1; while($objResult1 = mysql_fetch_array($objQuery1)){echo $n++." ) ".$objResult1["subname"]."<br><br>";}?></td>
                <td width="101" class="tblyy"><div align="center">
                  <?=$objResult["shirt"];?>
                  +
                  <input name="num" type="text" value="1"  style="width:20px">
                </div></td>
                <td class="tblyy"><input type="submit" name="submit" id="submit" class="" value="ตกลง" ></td>
              </tr>
              <? } ?>
            </table></th>
          </tr>
