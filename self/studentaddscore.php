...
<? 	
	...
	?>
    <tr><td style="white-space:nowrap;" class="tblyy" colspan="7"> <center>[<?=$objResult3["nameyear"]; ?>]<?=$objResult3["nameterm"];?></center></td> </tr>
    <? } 
	else { ?>
    <tr><td style="white-space:nowrap;" class="tblyy" colspan="9"> <center>รายชื่อ</center></td> </tr>
    <? } ?>
    <tr>
	...
	<?	if($objResult['creditid'] == $_GET["CusID"] and $_GET["Action"] == "Edit")
		...
		?> 
	<tr>
		<td width="5%" style="white-space:nowrap;" class="tblyy"><div align="center"><?=$i;?>
        <input type="hidden" name="ssss" size="5"  id="ssss" value="<?=$objResult["studentid"]?>"></div></td>
    	<td width="19%" style="white-space:nowrap;" class="tblyy"><div align="center"><?=$objResult["name"];?></div></td>
        <td width="9%"  class="tblyy"><div align="center"><?=$objResult2['subname'];?></div></td>
   		<td width="28%" style="white-space:nowrap;" class="tblyy"><div align="center"><?=$objResult2['code'];?></div></td>
        <td width="9%" style="white-space:nowrap;" class="tblyy"><div align="center">
        <input name="collectionpoints" type="text" id="collectionpoints" size="2" value="<?=$objResult['collectionpoints'];?>"></div></td>
        <td width="8%" style="white-space:nowrap;" class="tblyy"><div align="center">
        ...
        <td width="7%" style="white-space:nowrap;" class="tblyy"><div align="center"><?=$objResult['sumpoint'];?>
        <input type="hidden" name="subid" size="5" value="<?=$objResult["subid"];?>"></div></td>
        <? if($_SESSION["status"] == "adminexam" or $_SESSION["status"] == "admin"){ ?>
        <td width="7%" style="white-space:nowrap;" class="tblyy"><div align="center">
    ...
    <tr>
      ...
      <td style="white-space:nowrap;" class="tblyy"><div align="center"><?=$objResult2['code'];?></div></td>
		<td width="28%"  class="tblyy"><div align="center"><?=$objResult2['subname'];?></div></td>
      ...
      <? if($_SESSION["status"] == "adminexam" or $_SESSION["status"] == "admin"){ ?>
      <td width="7%" style="white-space:nowrap;" class="tblyy"><div align="center"><a href="<?=$_SERVER["PHP_SELF"];?>?Action=Edit&CusID=<?=$objResult['creditid'];?>&subid=<?=$objResult["subid"];?>&idaddterm=<?=$_GET["idaddterm"];?>&h_arti_id=<?=$_POST["h_arti_id"]?>">Edit</a></div></td>
      <td width="8%" style="white-space:nowrap;" class="tblyy"></td>
      <? }?> 
      </tr>
	<? } }?>
